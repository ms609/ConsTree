...
- [`Majority()`](https://constree.github.io/dev/reference/Majority.md)
  ...
  [`MR()`](https://constree.github.io/dev/reference/Majority.md) :
...
- [`BHVDistance()`](https://constree.github.io/dev/reference/BHVDistance.md)
  [`BHVDist()`](https://constree.github.io/dev/reference/BHVDistance.md)
  [`BHV()`](https://constree.github.io/dev/reference/BHVDistance.md) :
